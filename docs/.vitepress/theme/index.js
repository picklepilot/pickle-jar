        ...
        app.provide(
            ...
            new ThemeConfigurator().withParams({
                ...
                baseDropdownMenuItemButton:
                    'hover:bg-zinc-100 flex w-full px-2 py-1 rounded text-sm',
                ...
                baseDropdownInputContainer:
                    'relative flex w-full cursor-default overflow-hidden rounded-lg border border-zinc-200 bg-zinc-50 text-left ring-2 ring-transparent focus-within:border-zinc-500 focus-within:ring-zinc-200/60 hover:bg-zinc-50 focus:bg-white focus:shadow focus:outline-none sm:text-sm',
            })
        )
