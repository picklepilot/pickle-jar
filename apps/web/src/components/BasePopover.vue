    ...
    >
        ...
        >
            <PopoverPanel
                ...
                :class="
                    m(
                        'fixed z-10 transform overflow-x-hidden overflow-y-auto rounded-lg bg-[var(--card)] p-3 text-base shadow-lg ring-1 ring-[var(--border)] focus:outline-hidden sm:text-sm',
