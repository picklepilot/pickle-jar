<!-- Tailwind classes used:
        z-50, z-51, fixed, inset-0, bg-primary/10, overflow-y-auto, flex, min-h-full, items-center, justify-center, p-4, text-center, w-full, max-w-md, transform, overflow-hidden, rounded-lg, bg-[var(--card)], ring-1, ring-[var(--border)], p-6, text-left, align-middle, shadow-xl, transition-all, duration-300, space-y-4, text-lg, font-medium, leading-6, text-[var(--card-foreground)], mt-2, grow, text-sm, text-[var(--muted-foreground)], flex, items-center, justify-end, space-x-2, pt-4, py-4, justify-center
-->
<template>
    <TransitionRoot appear :show="modelValue" as="template">
        <Dialog as="div" @close="closeModal" class="relative">
            <TransitionChild
                ...
                leave-to="opacity-0"
            >
                <div class="z-50 fixed inset-0 bg-primary/10" />
            </TransitionChild>
