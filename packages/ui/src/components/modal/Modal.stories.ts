        ...
        template: `
            <div>
                ...
                <Modal v-bind="args" v-model:open="isOpen" @close="isOpen = false">
                    <template #title>Basic Modal</template>
                ...
                <Modal v-bind="args" v-model:open="isOpen" @close="isOpen = false">
                    <template #header>
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-foreground">Custom Header</h2>
        ...
        template: `
            <div class="flex flex-wrap gap-3">
                ...
                <Modal 
                    ...
                    @close="isOpen = false"
                >
                    <template #title>{{ currentSize.charAt(0).toUpperCase() + currentSize.slice(1) }} Modal</template>
                    <p class="text-muted-foreground">
        ...
        template: `
            <div>
                ...
                <Modal 
                    ...
                    @close="isOpen = false"
                >
                    <template #title>Modal Without Close Button</template>
                    <p class="text-muted-foreground">
    ...
    render: args => ({
        ...
        template: `
            <div>
                ...
                <Modal v-bind="args" v-model:open="isOpen" @close="isOpen = false">
                    <template #title>Modal with Scrollable Content</template>
                    <div 
                        ref="contentRef"
                        @scroll="handleScroll"
    ...
    render: args => ({
        ...
        template: `
            <div>
                ...
                <Modal v-bind="args" v-model:open="isOpen" @close="isOpen = false">
                    <template #title>Controlled Modal</template>
                    <p class="text-muted-foreground">
    ...
    render: args => ({
        ...
        template: `
            <div class="space-y-4">
                ...
                <Modal v-bind="args" v-model:open="isOpen" @close="isOpen = false">
                    <template #title>Z-Index Customization</template>
                    <div class="space-y-4">
                        <p class="text-muted-foreground">
