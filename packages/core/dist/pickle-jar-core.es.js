...
const U = "-", ae = (e) => {
  ...
  return {
    getClassGroupId: (l) => {
      const s = l.split(U);
      return s[0] === "" && s.length !== 1 && s.shift(), D(s, r) || le(l);
    },
  ...
  return pe(Object.entries(e.classGroups), t).forEach(([n, l]) => {
    _(l, o, n, r);
  }), o;
}, _ = (e, r, t, o) => {
  e.forEach((i) => {
  ...
  const i = o.map((n) => typeof n == "string" ? r + n : typeof n == "object" ? Object.fromEntries(Object.entries(n).map(([l, s]) => [r + l, s])) : n);
  return [t, i];
}) : e, ue = (e) => {
  if (e < 1)
    return {
  ...
  } = e, o = r.length === 1, i = r[0], n = r.length, l = (s) => {
    const u = [];
    let g = 0, m = 0, y;
...
function xe(e, ...r) {
  ...
  function l(u) {
    ...
    return t = fe(g), o = t.cache.get, i = t.cache.set, n = s, s(u);
  }
  function s(u) {
    const g = o(u);
    if (g)
...
const c = (e) => {
...
}, te = /^\[(?:([a-z-]+):)?(.+)\]$/i, we = /^\d+\/\d+$/, ve = /* @__PURE__ */ new Set(["px", "full", "screen"]), ke = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, Ce = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ze = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, Ae = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Se = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, C = (e) => M(e) || ve.has(e) || we.test(e), z = (e) => I(e, "length", je), M = (e) => !!e && !Number.isNaN(Number(e)), W = (e) => I(e, "number", M), P = (e) => !!e && Number.isInteger(Number(e)), Me = (e) => e.endsWith("%") && M(e.slice(0, -1)), a = (e) => te.test(e), A = (e) => ke.test(e), Ie = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Re = (e) => I(e, Ie, oe), Ge = (e) => I(e, "position", oe), Pe = /* @__PURE__ */ new Set(["image", "url"]), Ee = (e) => I(e, Pe, Le), Te = (e) => I(e, "", Ne), E = () => !0, I = (e, r, t) => {
  const o = te.exec(e);
  ...
  Ce.test(e) && !ze.test(e)
), oe = () => !1, Ne = (e) => Ae.test(e), Le = (e) => Se.test(e), Ve = () => {
  const e = c("colors"), r = c("spacing"), t = c("blur"), o = c("brightness"), i = c("borderColor"), n = c("borderRadius"), l = c("borderSpacing"), s = c("borderWidth"), u = c("contrast"), g = c("grayscale"), m = c("hueRotate"), y = c("invert"), x = c("gap"), v = c("gradientColorStops"), w = c("gradientColorStopPositions"), b = c("inset"), p = c("margin"), f = c("opacity"), h = c("padding"), R = c("saturate"), S = c("scale"), T = c("sepia"), B = c("skew"), Z = c("space"), F = c("translate"), L = () => ["auto", "contain", "none"], V = () => ["auto", "hidden", "clip", "visible", "scroll"], O = () => ["auto", a, r], d = () => [a, r], q = () => ["", C, z], j = () => ["auto", M, a], X = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], N = () => ["solid", "dashed", "dotted", "double", "none"], J = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], $ = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], G = () => ["", "0", a], H = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], k = () => [M, a];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
...
function Ue(e, r = {}) {
  const t = Object.entries(r).filter(([, o]) => o).map(([o]) => o).join(" ");
  return $e(e, t);
}
function Be(...e) {
  return Oe(ie(e));
...
const Ze = {
  ...
  { name: "default", config: se },
  { name: "dark", config: We }
];
function Xe(e) {
  const r = _e.find((t) => t.name === e);
  return (r == null ? void 0 : r.config) || se;
}
function Je(e) {
  const r = document.documentElement;
  Object.entries(e).forEach(([t, o]) => {
    r.style.setProperty(`--color-${t}`, o);
  });
}
function He(e) {
  return ne[e];
...
function Ke(e, r) {
  const t = document.documentElement, o = `--z-index-${e.replace(/([A-Z])/g, "-$1").toLowerCase()}`;
  t.style.setProperty(o, r.toString());
}
function Qe() {
  return { ...ne };
}
...
//# sourceMappingURL=pickle-jar-core.es.js.map
