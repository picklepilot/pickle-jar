...
export const ThemeCore: ThemeParams = {
    ...
    confirmationDialogContent: 'flex min-h-full items-center justify-center p-4 text-center',
    ...
    confirmationDialogButtonCancel: 'px-3 py-2.5 bg-transparent border border-transparent text-zinc-800 hover:text-zinc-900 hover:bg-zinc-900/10 hover:border-zinc-900/0',
    confirmationDialogButtonConfirm: 'px-3 py-2.5 shadow-xs hover:bg-zinc-900/80 rounded-md',
    confirmationDialogProcessing: 'flex items-center justify-end space-x-1.5 pt-4',
